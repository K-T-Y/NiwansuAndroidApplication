...
import com.example.niwansu_android_application.core.AdapterGetPatientList;
...
public class patientListFragment extends Fragment {
    ...
    private AdapterGetPatientList adapterDoctorList;
    ...
    public void fetchDoctors() {
        ...
        Call<List<Users>> call = apiInterface.getPatientsDetails(usercategory);
        call.enqueue(new Callback<List<Users>>() {
            @Override
            public void onResponse(Call<List<Users>> call, Response<List<Users>> response) {
                users = response.body();
                adapterDoctorList = new AdapterGetPatientList(users, getContext());
